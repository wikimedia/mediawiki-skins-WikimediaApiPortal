...
/**
 * @covers \MediaWiki\Skin\WikimediaApiPortal\Component\PrimaryNavComponent
 */
class PrimaryNavComponentTest extends MediaWikiIntegrationTestCase {
	...
	protected function getComponentClass(): string {
		return PrimaryNavComponent::class;
	}
}
